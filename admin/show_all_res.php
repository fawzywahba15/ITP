...
<!--                    php damit das dropdown menü beim value bleibt und sich nicht immer auf "all" zurücksetzt-->
                    <option value="" <?php if(!isset($_SESSION['status_filter'])) echo 'selected';?>>All</option>
                    <option value="neu" <?php if(isset($_SESSION['status_filter']) && $_SESSION['status_filter'] == 'neu') echo 'selected';?>>neu</option>
                    <option value="bestätigt" <?php if(isset($_SESSION['status_filter']) && $_SESSION['status_filter'] == 'bestätigt') echo 'selected';?>>bestätigt</option>
                    <option value="storniert" <?php if(isset($_SESSION['status_filter']) && $_SESSION['status_filter'] == 'storniert') echo 'selected';?>>storniert</option>
                </select>
